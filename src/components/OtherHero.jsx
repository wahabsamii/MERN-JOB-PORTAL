...
export default function OtherHero() {
    return (
      <div className="relative w-full h-[300px] flex items-center justify-center bg-cover bg-center" style={{ backgroundImage: `url(${bgimg})` }}>
        ...
        <div className="relative z-10 max-w-2xl text-white text-center px-6">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mt-2">Prescription glasses at remarkable prices</h1>
